...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, act=False, squeeze_excitation=False):
        ...
        #======刚加进去的========
     #   self.block.add_module('Coordinate Attention', CoordAtt(hidden_dim,hidden_dim))
...
class UniversalInvertedBottleneckBlock(nn.Module):
    def __init__(self,
        ...
        if self.middle_dw_kernel_size:
         ...
         # ======刚加进去的========
       # self.CoordinateAttention =CoordAtt(expand_filters, expand_filters)
        # self..add_module('Coordinate Attention', CoordAtt(expand_filters, expand_filters))
