...
# 模型配置文件
model_yaml_path = r"Custom_Model_cfg_2/yolo11_Ghost_Rep_Ghost_shufflev2_Detect_CA.yaml"
...
if __name__ == '__main__':
    ...
    results = model.train(data=data,
                          ...
                          save=True,
                          device="0",
                          name="yolo11_Ghost_Rep_Ghost_shufflev2_Detect_CA"+datetime.now().strftime("%Y%m%d_%H_%M"))