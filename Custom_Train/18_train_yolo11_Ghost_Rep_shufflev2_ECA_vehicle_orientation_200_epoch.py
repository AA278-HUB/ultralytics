...
model_yaml_path = r"C:\Users\Hunger\Desktop\ultralytics\runs\detect\yolo11_Ghost_Rep_shufflev2_ECA20251224_19_22\weights\last.pt"
# data="coco8.yaml"
...
if __name__ == '__main__':
    ...
    #                       save_period=1,
    #                       device="0",
    #                       name="yolo11_Ghost_Rep_shufflev2_ECA"+datetime.now().strftime("%Y%m%d_%H_%M"))